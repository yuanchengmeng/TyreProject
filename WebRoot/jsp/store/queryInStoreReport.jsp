...
<script type="text/javascript">
	function page(flag) {
		...
		location.href = "/TyreProject/store/queryStoreReport?flag=1&&pageNo=" + pageCount
					+ "&&pageSize=" + pageSize+"&&storeReport.timeStart="+timeStart+"&&storeReport.timeEnd="+timeEnd+"&&classId="+classId;
		} else if ("last" == flag) {
		location.href = "/TyreProject/store/lastStoreReportPage?flag=1&&pageNo=" + pageNo
					+ "&&pageSize=" + pageSize+"&&storeReport.timeStart="+timeStart+"&&storeReport.timeEnd="+timeEnd+"&&classId="+classId;
		} else if ("next" == flag) {
		location.href = "/TyreProject/store/nextStoreReportPage?flag=1&&pageNo=" + pageNo
					+ "&&pageSize=" + pageSize+"&&storeReport.timeStart="+timeStart+"&&storeReport.timeEnd="+timeEnd+"&&classId="+classId;
		} else if ("go" == flag) {
		   if (parseInt(gotopage) <= parseInt(pageCount)){
				location.href = "/TyreProject/store/queryStoreReport?flag=1&&pageNo="
	...
	function exportIn() {
	    ...
	    var timeEnd = document.getElementById("timeEnd").value;
	    var classId = document.getElementById("classId").value;
		location.href = "/TyreProject/store/exportStoreReportExcel?flag=1&&storeReport.timeStart="+timeStart+"&&storeReport.timeEnd="+timeEnd+"&&classId="+classId;
	 }
												...
												<tbody>
													<tr>
														...
														<td
															...
															class="dqwz"><b>当前位置：</b> 轮胎库存统计</span></td>
