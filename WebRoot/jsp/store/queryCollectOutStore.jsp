...
<script type="text/javascript">
	...
	function detailPage(id) {
		...
		location.href = "/TyreProject/store/queryStore?flag=2&&productID="+ id+"&&pageNo="+pageNo+ "&&pageSize=" + pageSize;
		}
	function page(flag) {
	    var dateId = document.getElementById("dateId").value;
		var pageSize = document.getElementById("pageSize").value;
		...
		location.href = "/TyreProject/store/nextCollectPage?flag=3&&pageNo=" + pageNo+ "&&pageSize=" + pageSize+"&&store.inDate="+dateId;
			...
			location.href = "/TyreProject/store/queryCollectStore?flag=3&&pageNo="+ gotopage + "&&pageSize=" + pageSize+"&&store.inDate="+dateId;
			}
													...
													<tr>
														...
														<br>
															<table width="75%" border="0" cellspacing="0"
																cellpadding="0">
																<tr>
																	<td>&nbsp;出库日期： <input type="text" name="store.inDate" id="dateId"
