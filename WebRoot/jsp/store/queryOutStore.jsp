															...
															<table width="100%" border="0" cellpadding="0"
																...
																<tr class="query_two">
																	<td>条形码:&nbsp;<input type="text"
																		...
																		style="width: 100px;" value="${store.barcode }"></td>
																...
																<tr class="query_one">
																	...
																	<td>&nbsp;车牌号：&nbsp;<input type="text"
																		name="store.carNo" value="${store.carNo}"
																		id="outMan" style="width: 100px;"> 
																	 &nbsp;&nbsp;&nbsp;&nbsp;<input
																...
																<tbody>
																	<s:iterator value="storeList" var="store"
																		...
																		<tr class="even">
																			...
																			<td><s:property value="#store.vehicle.getVehicleNo()" />
																			</td>
