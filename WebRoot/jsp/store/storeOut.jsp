		...
		<tr>
			<td valign="top">
				<table border="0" cellpadding="0" cellspacing="0"
					class="cTableBorder">
					<tr>
						<td align="left" class="navig">位置：出库轮胎信息详情</td>
					</tr>
				</table>
												...
												<td>
													<table width="100%" border="0" cellpadding="0"
														cellspacing="1">
															...
															<tr class="query_two">
																<td>规格型号</td>
																<td colspan="3">${store.seOrderEntry.product.FName}</td>
															</tr>
															 <tr class="query_one">
																<td>入库时间</td>
															...
															<tr class="query_one">
																<td>出库时间</td>
																<td colspan="3">${store.outTime}</td>
															</tr>
															<tr class="query_two">
																<td>出库人</td>
																<td colspan="3">${store.outMan}</td>
															</tr>
															<tr class="query_one">
																<td>购买单位</td>
																<td colspan="3">${store.seOrderEntry.seOrder.customer.FName}</td>
															</tr>
															<tr class="query_two">
																<td>订单编号</td>
																<td colspan="3">${store.seOrderEntry.seOrder.fbillNo}</td>
															</tr>
														<tr>
