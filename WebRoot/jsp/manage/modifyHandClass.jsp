...
<body>
	<s:form action="modifyHandClass" namespace="/shape" theme="simple">
		...
		<s:hidden name="handClass.id" value="%{handClass.id}"></s:hidden>
			...
			<tr>
				<td valign="top">
					<table border="0" cellpadding="0" cellspacing="0"
						class="cTableBorder">
						<tr>
							<td align="left" class="navig"><br>位置：修改班组</td>
						</tr>
					</table>
														...
														<table width="100%" border="0" cellpadding="0"
															...
															<tr class="query_one">
																...
																<td colspan="3"><input type="text"
																	name="handClass.name" value="${handClass.name }">
																</td>
															</tr>
															<tr class="query_two">
																<td width="20%">班组描述</td>
																<td colspan="3"><s:textarea cols="50" rows="3"  name="handClass.description"></s:textarea>
																</td>
															</tr>
															<tr>
