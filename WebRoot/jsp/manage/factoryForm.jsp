...
<body>
	<s:form action="addFactory" namespace="/manage" theme="simple">
			...
			<tr>
				<td valign="top">
					<table border="0" cellpadding="0" cellspacing="0"
						class="cTableBorder">
						<tr>
							<td align="left" class="navig"><br>位置：新增仓库</td>
						</tr>
					</table>
												...
												<tr>
													<td>
														<table width="100%" border="0" cellpadding="0"
															...
															<tr class="query_one">
																<td width="20%">仓库名称</td>
																<td colspan="3"><s:textfield name="factory.name"/></td>
															</tr>
															<tr class="query_two">
																<td width="20%">仓库描述</td>
																<td colspan="3"><s:textarea cols="50" rows="3"  name="factory.description"/></td>
															</tr>
															<tr>
