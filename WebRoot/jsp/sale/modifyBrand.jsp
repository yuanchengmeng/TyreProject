...
<body>
	<s:form action="modifyBrand" namespace="/sale" theme="simple">
		...
		<s:hidden name="brand.id" value="%{brand.id}"></s:hidden>
			...
			<tr>
				<td valign="top">
					<table border="0" cellpadding="0" cellspacing="0"
						class="cTableBorder">
						<tr>
							<td align="left" class="navig"><br>位置：修改品牌</td>
						</tr>
					</table>
												...
												<tr>
													<td>
														<table width="100%" border="0" cellpadding="0"
															...
															<tr class="query_one">
																<td width="20%">品牌名称</td>
																<td colspan="3"><s:textfield name="brand.name" id="nID"/>
																</td>
															</tr>
															<tr class="query_two">
																<td width="20%">品牌代码</td>
																<td colspan="3"><s:textfield name="brand.code" id="cID"/>
																</td>
															</tr>
															<tr>
