...
<body>
	${success}
	<s:form action="getSeOrderEntryById" namespace="/sale">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															出库人:<input
															type="text" name="seOrder.outMan" id="outMan"
															value="${seOrder.outMan}" size="7">
															&nbsp;
															车牌号:<select name="seOrder.carId">
																	<option value=0>
																		--请选择--
																	</option>
																	<s:iterator var="vehicle" value="vehicleList">
																		<s:if test="seOrder.carId==#vehicle.getId()">
																			<option
																				value=<s:property value="#vehicle.getId()" />
																				selected>
																				<s:property value="#vehicle.getVehicleNo()" />
																			</option>
																		</s:if>
																		<s:else>
																			<option
															...
															&nbsp;&nbsp;&nbsp;&nbsp;
															<input style="color:white" type="submit" value="查询" class="input_ok">
