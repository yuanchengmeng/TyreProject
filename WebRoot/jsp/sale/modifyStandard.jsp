...
<body>
	<s:form action="modifyStandard" namespace="/sale" theme="simple">
		...
		<s:hidden name="standard.id" value="%{standard.id}"></s:hidden>
			...
			<tr>
				<td valign="top">
					<table border="0" cellpadding="0" cellspacing="0"
						class="cTableBorder">
						<tr>
							<td align="left" class="navig"><br>位置：修改规格</td>
						</tr>
					</table>
												...
												<tr>
													<td>
														<table width="100%" border="0" cellpadding="0"
															...
															<tr class="query_one">
																<td width="20%">规格名称</td>
																<td colspan="3"><s:textfield name="standard.name" id="nID"/>
																</td>
															</tr>
															<tr class="query_two">
																<td width="20%">速度级别</td>
																<td colspan="3"><s:textfield name="standard.speed" id="sID"/>
																</td>
															</tr>
															<tr class="query_one">
																<td width="20%">花纹</td>
															...
															<tr class="query_two">
																<td width="20%">规格代码</td>
																<td colspan="3"><s:textfield name="standard.code" id="cID"/>
																</td>
															</tr>
															<tr>
