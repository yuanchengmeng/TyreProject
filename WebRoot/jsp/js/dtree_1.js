...
// Tree object
function dTree(objName, iPath, formId,ids) { 	this.config = {
		target					: null,
		folderLinks			: true,
		useSelection		: true,
		useCookies			: true,
	...
	this.icon = {
		root				: '/TyreProject/jsp/images/base.gif',
		folder				: '/TyreProject/jsp/images/folder.gif',
		folderOpen			: '/TyreProject/jsp/images/folderopen.gif',
		node				: '/TyreProject/jsp/images/page.gif',
		empty				: '/TyreProject/jsp/images/empty.gif',
		line				: '/TyreProject/jsp/images/line.gif',
		join				: '/TyreProject/jsp/images/join.gif',
		joinBottom			: '/TyreProject/jsp/images/joinbottom.gif',
		plus				: '/TyreProject/jsp/images/plus.gif',
		plusBottom			: '/TyreProject/jsp/images/plusbottom.gif',
		minus				: '/TyreProject/jsp/images/minus.gif',
		minusBottom			: '/TyreProject/jsp/images/minusbottom.gif',
		nlPlus				: '/TyreProject/jsp/images/nolines_plus.gif',
		nlMinus				: '/TyreProject/jsp/images/nolines_minus.gif'
	};
	this.parEnum = "";
	this.obj = objName;
	this.aNodes = [];
...
dTree.prototype.node = function(node, nodeId) {
	...
	if(this.config.useCheckBox && nodeId!=0){
        ...
        var id=ids.split(",");        var m=0;        for(var i=0;i<id.length;i++){        	if(node.id==id[i]){        		 m=1;        	}        }        if(m==1){        	str += '<input type="checkbox" checked name="id" id="c'+this.parEnum+'" onClick="caBox(\''+this.formId+'\',\'c'+this.parEnum+'\')" value="' + node.id +'" class="cx"/>';        }else{        	str += '<input type="checkbox" name="id" id="c'+this.parEnum+'" onClick="caBox(\''+this.formId+'\',\'c'+this.parEnum+'\')" value="' + node.id +'" class="cx"/>';        }		
	}
