...
<script type="text/javascript" charset="utf-8"
	src="<%=path%>/jsp/js/dtree_1.js"></script>
<body>
	<s:form action="modifySysMenu" id="menuForm" method="post" namespace="/system" theme="simple">
		...
		<tr>
			<td valign="top">
				<table border="0" cellpadding="0" cellspacing="0"
					class="cTableBorder">
					<tr>
						<td align="left" class="navig">位置：修改角色 <input type="hidden"
							value="modifyIn" name="flag">
						</td>
					</tr>
				</table>
													...
													<table width="100%" border="0" cellpadding="0"
														...
														<tr class="query_two">
															...
															<td colspan="3">
															    <input type="hidden" name="pageNo" id="pageNo" value="${pageNo }">
															     ...
															     <input type="text" value="${sysRole.name}" id=""
																name="sysRole.name">
														</tr>
														<tr class="query_one">
															<td>角色描述</td>
															<td colspan="3"><input type="text" value="${sysRole.descr}" name="sysRole.descr">
															<input type="hidden" value="${ids}" id="ids" name="ids">
															<input type="hidden" value="${sysRole.id}" name="sysRole.id">
															</td>
														</tr>
														<tr class="query_two">
															<td>角色权限</td>
														...
														<tr>
															<td colspan="4" class="td_page_right"><input
																...
																type="button" value="返回" class="input_ok">
															</td>
														</tr>
													</table>
												</td>
